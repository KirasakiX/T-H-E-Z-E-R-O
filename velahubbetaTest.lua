...
NotificacaoNightMystic("Vela Hub Beta", "Script Currently in Beta Testing!")
...
NotificacaoNightMystic("Vela Hub", "Join the Discord to receive notifications about the script!")
