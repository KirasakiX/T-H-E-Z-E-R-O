...
local sOK  = S("9120301979",0.6)
local sTing= S("9120302013",0.5)
local sErr = S("9120302345",0.6)

-- Tween
local function tw(o,p,t,s,d)
    TweenService:Create(o,TweenInfo.new(t or .25,s or Enum.EasingStyle.Quad,d or Enum.EasingDirection.Out),p):Play()
end

-- Colours
local C = {
    bg    = Color3.fromRGB(12,4,20),
    card  = Color3.fromRGB(18,6,28),
    inp   = Color3.fromRGB(8,2,14),
    p1    = Color3.fromRGB(255,105,180),
    p2    = Color3.fromRGB(255,172,212),
    p3    = Color3.fromRGB(200,48,118),
    pD    = Color3.fromRGB(100,28,65),
    pur   = Color3.fromRGB(188,105,255),
    purD  = Color3.fromRGB(82,26,140),
    gold  = Color3.fromRGB(255,210,80),
    grn   = Color3.fromRGB(60,235,130),
    red   = Color3.fromRGB(255,68,88),
    wht   = Color3.fromRGB(255,242,250),
...
local _=Instance.new("UICorner"); _.CornerRadius=UDim.new(0,18); _.Parent=Panel
local _=Instance.new("UIStroke"); _.Color=C.p3; _.Thickness=1.4; _.Parent=Panel
local _=Instance.new("UIGradient")
_.Color=ColorSequence.new(Color3.fromRGB(24,7,38),Color3.fromRGB(11,3,18))
_.Rotation=145; _.Parent=Panel

-- Top accent
local Acc=Instance.new("Frame")
Acc.Size=UDim2.new(0.5,0,0,2); Acc.Position=UDim2.new(0.25,0,0,0)
Acc.BackgroundColor3=C.p1; Acc.BorderSizePixel=0; Acc.ZIndex=3; Acc.Parent=Panel
local _=Instance.new("UICorner"); _.CornerRadius=UDim.new(0,2); _.Parent=Acc
local _=Instance.new("UIGradient")
_.Color=ColorSequence.new({
    ColorSequenceKeypoint.new(0,Color3.fromRGB(0,0,0)),
    ColorSequenceKeypoint.new(.5,C.p1),
    ColorSequenceKeypoint.new(1,Color3.fromRGB(0,0,0)),
}); _.Parent=Acc

-- Logo ring  y=16
local Ring=Instance.new("Frame")
Ring.Size=UDim2.new(0,58,0,58); Ring.Position=UDim2.new(.5,-29,0,16)
Ring.BackgroundColor3=Color3.fromRGB(42,9,60)
Ring.BorderSizePixel=0; Ring.ZIndex=4; Ring.Parent=Panel
local _=Instance.new("UICorner"); _.CornerRadius=UDim.new(1,0); _.Parent=Ring
local _=Instance.new("UIStroke"); _.Color=C.p1; _.Thickness=2; _.Parent=Ring
local _=Instance.new("UIGradient")
_.Color=ColorSequence.new(Color3.fromRGB(70,14,100),Color3.fromRGB(25,5,40))
_.Rotation=135; _.Parent=Ring
local Img=Instance.new("ImageLabel")
Img.Size=UDim2.new(0,38,0,38); Img.Position=UDim2.new(.5,-19,.5,-19)
Img.BackgroundTransparency=1; Img.Image="rbxassetid://73902065845651"
Img.ScaleType=Enum.ScaleType.Fit; Img.ZIndex=5; Img.Parent=Ring

-- Halo glow
local Halo=Instance.new("ImageLabel")
Halo.Size=UDim2.new(0,88,0,88); Halo.Position=UDim2.new(.5,-44,0,-6)
Halo.BackgroundTransparency=1; Halo.Image="rbxassetid://5028857084"
Halo.ImageColor3=C.p3; Halo.ImageTransparency=0.55; Halo.ZIndex=3; Halo.Parent=Panel
...
Sub.Size=UDim2.new(1,-16,0,16); Sub.Position=UDim2.new(0,8,0,110)
Sub.BackgroundTransparency=1; Sub.Text="Nhap key de tiep tuc"
Sub.TextColor3=C.pD; Sub.TextSize=11; Sub.Font=Enum.Font.Gotham
Sub.ZIndex=4; Sub.Parent=Panel

-- Divider y=132
local function mkDiv(y)
    local d=Instance.new("Frame")
    d.Size=UDim2.new(1,-28,0,1); d.Position=UDim2.new(0,14,0,y)
    d.BackgroundColor3=C.pD; d.BackgroundTransparency=0.4
    d.BorderSizePixel=0; d.ZIndex=3; d.Parent=Panel
end
mkDiv(132)

-- KEY LABEL  y=142
local KLbl=Instance.new("TextLabel")
KLbl.Size=UDim2.new(1,-28,0,14); KLbl.Position=UDim2.new(0,14,0,142)
KLbl.BackgroundTransparency=1; KLbl.Text="KEY XAC THUC"
KLbl.TextColor3=C.pD; KLbl.TextSize=9; KLbl.Font=Enum.Font.GothamBold
KLbl.TextXAlignment=Enum.TextXAlignment.Left; KLbl.ZIndex=4; KLbl.Parent=Panel

-- Input row  y=158  h=36
local IR=Instance.new("Frame")
IR.Size=UDim2.new(1,-28,0,36); IR.Position=UDim2.new(0,14,0,158)
IR.BackgroundColor3=C.inp; IR.BorderSizePixel=0; IR.ZIndex=4; IR.Parent=Panel
...
KB.TextColor3=C.p2; KB.TextSize=12; KB.Font=Enum.Font.GothamBold
KB.TextXAlignment=Enum.TextXAlignment.Left; KB.ClearTextOnFocus=false
KB.BorderSizePixel=0; KB.ZIndex=5; KB.Parent=IR
local _=Instance.new("UIPadding"); _.PaddingLeft=UDim.new(0,10); _.Parent=KB

local VB=Instance.new("TextButton")
VB.Size=UDim2.new(0,66,0,28); VB.Position=UDim2.new(1,-70,.5,-14)
VB.BackgroundColor3=C.p3; VB.Text="XAC MINH"
VB.TextColor3=C.wht; VB.TextSize=10; VB.Font=Enum.Font.GothamBold
VB.AutoButtonColor=false; VB.BorderSizePixel=0; VB.ZIndex=5; VB.Parent=IR
local _=Instance.new("UICorner"); _.CornerRadius=UDim.new(0,7); _.Parent=VB
local _=Instance.new("UIGradient"); _.Color=ColorSequence.new(C.p1,C.p3); _.Rotation=135; _.Parent=VB

-- Status  y=198
local Stat=Instance.new("TextLabel")
Stat.Size=UDim2.new(1,-28,0,20); Stat.Position=UDim2.new(0,14,0,198)
Stat.BackgroundTransparency=1; Stat.Text=""
Stat.TextColor3=C.pD; Stat.TextSize=10; Stat.Font=Enum.Font.Gotham
Stat.TextXAlignment=Enum.TextXAlignment.Left; Stat.TextWrapped=true
Stat.ZIndex=4; Stat.Parent=Panel
...
local _=Instance.new("UICorner"); _.CornerRadius=UDim.new(0,11); _.Parent=GK
local _=Instance.new("UIStroke"); _.Color=C.p3; _.Thickness=1; _.Parent=GK
local _=Instance.new("UIGradient")
_.Color=ColorSequence.new(Color3.fromRGB(32,8,50),Color3.fromRGB(15,4,24))
_.Rotation=135; _.Parent=GK

-- dot blink
local GKDot=Instance.new("Frame")
GKDot.Size=UDim2.new(0,5,0,5); GKDot.Position=UDim2.new(0,12,.5,-3)
GKDot.BackgroundColor3=C.p1; GKDot.BorderSizePixel=0; GKDot.ZIndex=5; GKDot.Parent=GK
local _=Instance.new("UICorner"); _.CornerRadius=UDim.new(1,0); _.Parent=GKDot

local GKT=Instance.new("TextLabel")
GKT.Size=UDim2.new(1,-24,0,22); GKT.Position=UDim2.new(0,22,0,6)
GKT.BackgroundTransparency=1; GKT.Text="Lay key mien phi"
GKT.TextColor3=C.p2; GKT.TextSize=12; GKT.Font=Enum.Font.GothamBold
GKT.TextXAlignment=Enum.TextXAlignment.Left; GKT.ZIndex=5; GKT.Parent=GK

local GKS=Instance.new("TextLabel")
GKS.Size=UDim2.new(1,-24,0,16); GKS.Position=UDim2.new(0,22,0,28)
GKS.BackgroundTransparency=1; GKS.Text="Nhan de sao chep link, dan vao trinh duyet"
GKS.TextColor3=C.pD; GKS.TextSize=9; GKS.Font=Enum.Font.Gotham
GKS.TextXAlignment=Enum.TextXAlignment.Left; GKS.ZIndex=5; GKS.Parent=GK

mkDiv(290)

-- SUPPORT BUTTON  y=298  h=46
local SP=Instance.new("TextButton")
SP.Size=UDim2.new(1,-28,0,46); SP.Position=UDim2.new(0,14,0,298)
SP.BackgroundColor3=Color3.fromRGB(14,4,26); SP.Text=""
SP.AutoButtonColor=false; SP.BorderSizePixel=0; SP.ZIndex=4; SP.Parent=Panel
local _=Instance.new("UICorner"); _.CornerRadius=UDim.new(0,11); _.Parent=SP
local _=Instance.new("UIStroke"); _.Color=C.purD; _.Thickness=1; _.Parent=SP
local _=Instance.new("UIGradient")
_.Color=ColorSequence.new(Color3.fromRGB(22,6,44),Color3.fromRGB(12,3,22))
_.Rotation=135; _.Parent=SP

local SPDot=Instance.new("Frame")
SPDot.Size=UDim2.new(0,5,0,5); SPDot.Position=UDim2.new(0,12,.5,-3)
SPDot.BackgroundColor3=C.pur; SPDot.BorderSizePixel=0; SPDot.ZIndex=5; SPDot.Parent=SP
local _=Instance.new("UICorner"); _.CornerRadius=UDim.new(1,0); _.Parent=SPDot

local SPT=Instance.new("TextLabel")
SPT.Size=UDim2.new(1,-24,0,20); SPT.Position=UDim2.new(0,22,0,6)
SPT.BackgroundTransparency=1; SPT.Text="Ho tro - Discord"
SPT.TextColor3=C.pur; SPT.TextSize=12; SPT.Font=Enum.Font.GothamBold
SPT.TextXAlignment=Enum.TextXAlignment.Left; SPT.ZIndex=5; SPT.Parent=SP

local SPS=Instance.new("TextLabel")
SPS.Size=UDim2.new(1,-24,0,16); SPS.Position=UDim2.new(0,22,0,26)
SPS.BackgroundTransparency=1; SPS.Text="discord.gg/enxE3dEbTP"
SPS.TextColor3=C.purD; SPS.TextSize=9; SPS.Font=Enum.Font.Gotham
SPS.TextXAlignment=Enum.TextXAlignment.Left; SPS.ZIndex=5; SPS.Parent=SP
...
-- ENTRY ANIMATE
-- Panel truot tu duoi len, KHONG dung transparency (tranh bug an)
Panel.Position = UDim2.new(0.5,-W/2, 0.6,-H/2)
tw(Panel,{Position=UDim2.new(0.5,-W/2,0.5,-H/2)},
    0.45, Enum.EasingStyle.Back, Enum.EasingDirection.Out)

-- Halo pulse
task.spawn(function()
    while SG and SG.Parent do
        tw(Halo,{ImageTransparency=0.2},1.0); task.wait(1.1)
        tw(Halo,{ImageTransparency=0.65},1.0); task.wait(1.1)
    end
end)
-- GKDot blink
task.spawn(function()
    while SG and SG.Parent do
        tw(GKDot,{BackgroundTransparency=0.85},0.55); task.wait(0.6)
        tw(GKDot,{BackgroundTransparency=0},0.55); task.wait(0.6)
    end
end)

-- LOGIC
local function setStat(msg,col)
    Stat.Text=msg; Stat.TextColor3=col or C.pD
end
local function flash(ok)
    tw(IR,{BackgroundColor3=ok and Color3.fromRGB(3,16,8) or Color3.fromRGB(20,3,4)},0.1)
    task.delay(0.38,function() tw(IR,{BackgroundColor3=C.inp},0.2) end)
end
    ...
    task.delay(0.6,function()
        ...
        task.delay(0.32,function()
            ...
            task.spawn(function()
                ...
                wSG.Parent         = plr2:WaitForChild("PlayerGui")

                -- Container trong suot hoan toan, co dinh giua tren
                ...
                -- Chi co label, khong co nen, khong co khung
                ...
                -- Tao mau RGB cho tung ky tu
                local function charColor(idx, offset)
                    local hue = ((offset + idx * 0.07) % 1)
                    local r,g,b = Color3.fromHSV(hue,1,1).R, Color3.fromHSV(hue,1,1).G, Color3.fromHSV(hue,1,1).B
                    return string.format("#%02X%02X%02X", math.floor(r*255), math.floor(g*255), math.floor(b*255))
                end

                -- Wrap text thanh rich text moi chu 1 mau
                local function rainbowText(str, offset)
                    local result = ""
                    for i = 1, #str do
                        ...
                        if ch == " " then
                            ...
                            local col = charColor(i, offset)
                            result = result .. '<font color="'..col..'">'..ch..'</font>'
                        end
                    end
                    return result
                end
                ...
                -- Tinh thoi gian
                local function getLeftSec()
                    if _keyExpireAt == nil then return nil end
                    local nowMs = os.time() * 1000
                    return math.max(0, (_keyExpireAt - nowMs) / 1000)
                end

                -- Vong lap chinh: cap nhat mau + dem nguoc
                local offset    = 0
                local lastSec   = -1
                local curText   = makeText(_keyExpireAt == nil and "Vinh vien" or "...")

                RS.RenderStepped:Connect(function(dt)
                    if not (wSG and wSG.Parent) then return end
                    offset = (offset + dt * 0.55) % 1
                    -- Cap nhat text moi giay
                    local left = getLeftSec()
                    local timeStr
                    if left == nil then
                        timeStr = "Vinh vien"
                    elseif left <= 0 then
                        ...
                        timeStr = fmtTime(left)
                    end
                    local full = makeText(timeStr)
                    -- Render mau
                    Lbl.Text = rainbowText(full, offset)
                end)
            end)
            -- ===========================
...
L_NEW_TEXT["Text"] = "Tày Slayer Hub"
...
GK.MouseButton1Click:Connect(function()
    pcall(function() setclipboard(GETKEY) end)
    GKT.Text="Da sao chep! Dan vao trinh duyet"
    GKT.TextColor3=C.grn
    GKS.Text=GETKEY
    task.delay(2.5,function()
        GKT.Text="Lay key mien phi"
        GKT.TextColor3=C.p2
        GKS.Text="Nhan de sao chep link, dan vao trinh duyet"
        GKS.TextColor3=C.pD
    end)
end)
GK.MouseEnter:Connect(function() tw(GK,{BackgroundColor3=Color3.fromRGB(30,9,46)},0.12) end)
GK.MouseLeave:Connect(function() tw(GK,{BackgroundColor3=Color3.fromRGB(19,6,30)},0.12) end)

SP.MouseButton1Click:Connect(function()
    pcall(function() setclipboard(DISCORD) end)
    local old=SPT.Text
    SPT.Text="Da sao chep Discord!"; SPT.TextColor3=C.grn
    task.delay(2,function() SPT.Text=old; SPT.TextColor3=C.pur end)
end)
SP.MouseEnter:Connect(function() tw(SP,{BackgroundColor3=Color3.fromRGB(24,7,46)},0.12) end)
SP.MouseLeave:Connect(function() tw(SP,{BackgroundColor3=Color3.fromRGB(14,4,26)},0.12) end)

repeat task.wait(0.2) until not SG or not SG.Parent
